...
#    Updated: 2024/11/02 22:00:58 by eelkabia         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
F_BONUS = ft_lstsize_bonus.c ft_lstadd_back_bonus.c ft_lstadd_front_bonus.c ft_lstnew_bonus.c ft_lstlast_bonus.c
OBJ = $(FUNCTION:.c=.o)
